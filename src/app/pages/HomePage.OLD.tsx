          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <Link to="/products/sun-ninja-tents">
                <Button 
                  size="lg"
                  className="w-full sm:w-auto bg-[#ff9f1c] hover:bg-[#ff9f1c]/90 text-black font-semibold text-lg px-8 py-6 gap-2 shadow-xl"
                >
                  Shop Beach Tents
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 bg-[#ff9f1c] text-black font-bold px-6 py-3 rounded-full shadow-lg">
                Save 28%
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <Link to="/products/sun-ninja-tents" className="block">
                <Button 
                  size="lg"
                  className="w-full bg-[#ff9f1c] hover:bg-[#ff9f1c]/90 text-black font-semibold py-6 gap-2"
                >
                  Shop Now
                  <ArrowRight className="w-5 h-5" />
                </Button>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-primary to-[#0052a3] rounded-3xl p-8 md:p-16 text-white text-center">
            ...
            <Link to="/products/sun-ninja-tents">
              <Button 
                size="lg"
                className="bg-[#ff9f1c] hover:bg-[#ff9f1c]/90 text-black font-semibold text-lg px-12 py-6 gap-2 shadow-xl"
              >
                Shop Now
                <ArrowRight className="w-5 h-5" />
              </Button>
